        ...
        <div className="row align-items-center">
          <div className="col-md-6 text-white mt-2">
            ...
            <p className="mt-4 text-justify">
              Crafting seamless and engaging web experiences through modern technologies...
            </p>
            <div className="mt-4 d-flex gap-3 flex-wrap">
              <a href="/resume.pdf" download="Siddaveer_Swamy_Resume.pdf" className="btn btn-outline-light px-4 py-2 fw-bold">
                Download Resume
              </a>
              <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-outline-light px-4 py-2 fw-bold">
                View Resume
              </a>
            </div>
          </div>
